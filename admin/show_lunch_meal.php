...
include("header.php");
	...
	$data			=	mysql_query("SELECT * FROM `lunchmenu`")or die(mysql_error());
...
?>
	...
	<div class="container">
	<h2 class="food_head">lunch  Meal List</h2>
				...
				<div class="col-md-1 th">Action</div>
					...
					?>
						<div class="row tr">
							...
							<div class="col-md-1 td"><a href="edit_lunch_meal.php?id=<?php echo $row['id'];?>" />Edit</a>/<a onclick="return confirm('Are you sure you want to delete this record')" href="delete_lunch_meal.php?id=<?php echo $row['id'];?>" />Delete</a></div>
						</div>
					<?php
						}
					?>
