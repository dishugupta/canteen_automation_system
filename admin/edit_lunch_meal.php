<?php
	...
	@$data			=	mysql_query("SELECT * FROM `lunchmenu` WHERE `id`='$id'");
...
<form action="edit_lunch_mealaction.php" method="post">
<fieldset><legend>Lunch Detail</legend>
...
<label><span>&nbsp;</span><input type="submit" name="submit" value="Update" onclick="return addlunch();" />
<input type="button" name="cancle" value="Go back" onclick="window.location='show_lunch_meal.php'" /></label>
</fieldset>
